            ...
            <div style={{backgroundColor:"black"}} className="App">
                ...
                <div className='container'>
                    ...
                    <div className='bg-slate-900 w-[615px] h-[79px] mt-[36px] ml-[859px] '>
                        ...
                        <button className="bg-slate-900 h-[44px] hover:bg-slate-600 text-white font-bold py-2 px-4 rounded">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 ">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                            </svg>

                        </button>
                        <button className="rounded bg-slate-900 h-[44px] hover:bg-slate-600 text-white font-bold py-2 px-4 ml-[504px] ">
                    ...
                    <button className="rounded bg-green-500 h-[44px]  text-white font-bold py-2 px-4 ml-[504px]  w-[503px] mt-[53px] ml-[906px] ">
                        COMPRAR
                    </button>
