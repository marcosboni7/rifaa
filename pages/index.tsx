  ...
  return (
    ...
    <div className="App">
      ...
      <div className="container text-3xl mx-auto mt-40  ">
        ...
        <div className="grid">
          <div className='rounded bg-gray-600 w-1/2 h-30 mt-5'>
      ...
      <div className='container text mt-[-94px] '>
        <h1 className='text-white font-bold text-2xl mt-[-71px] ml-[333px] '>Rifa valendo uma pikaaaaaaa</h1>
        <h1 className='text-white font-bold text-2xl mt-[-1px] ml-[333px] '>21/01/2023</h1>
        <h1 className='text-white font-bold text-2xl mt-[-1px] ml-[333px] '>R$ 10,00</h1>
