        ...
        <div className="App">
            <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
                <div className="w-full p-6 m-auto bg-white rounded shadow-lg ring-2 ring-slate-900 lg:max-w-md">
                    ...
                    <p className="mt-8 text-xs font-light text-center text-slate-900"> Crie sua conta aqui! <a href="cadastro.tsx"
                        className="font-medium text-slate-900">Clique aqui</a></p>
                </div>
            </div>
        </div>
