...
export default function pix() {
    ...
    return (
        <div style={{ backgroundColor: "black" }}>
            <div style={{ overflow: "hidden", backgroundColor: "black" }} className="App">
                <header className="bg-black bg-opacity-5 text-white shadow-lg hidden md:block">
                ...
                <div className="">
                    ...
                    <div className="grid ml-[351px] ">
                        <div className='rounded bg-gray-600 w-1/2 h-30 mt-5 w-[1485px] ml-[-226px] '>
                    ...
                    <div className="container-2 ml-[-162px] mt-[-68px] ">
                        <div className='grid grid-cols-5 gap-5 ml-[528px]  '>
                            <div className="text-white ml-[-16px] ">0.10 centavos vira 5Mil</div>
                            <div className="text-white ml-[-34px] ">19/01/2023 às 08:58</div>
                            <div className="text-white ml-[-65px] ml-[-14px] ">R$ 0,10</div>
                            <div className="text-white ml-[-33px] ">00:00</div>
                            <div className="text-green-500 ml-[-69px] ">Efetuar pagamento</div>
                        </div>
                    </div>
                </div>
            </div>
