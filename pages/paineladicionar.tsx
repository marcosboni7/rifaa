...
export default function paineladicionar() {
    ...
    return (
        <div>
            ...
            <div className="md:grid md:grid-cols-3 md:gap-6 mt-[-782px] ml-[-466px] ">
                        ...
                        <div className="shadow sm:rounded-md sm:overflow-hidden">
                            <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="about" name="about" rows={3} className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Digite seu titulo"></textarea>
                                </div>
                                <div>
                                    <label form="about" className="block text-sm font-medium text-gray-700">
                                        Valor da rifa
                                    ...
                                    <div className="mt-1">
                                        <textarea id="about" name="about" rows={3} className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Digite o valor da rifa"></textarea>
                                    </div>
                                    <div>
                                    <label form="about" className="block text-sm font-medium text-gray-700">
                                        Selecion a data
                                    </label>
                                        <input id="date" type="date" value="2017-06-01"></input>
